...
public class NexusRedRight extends LinearOpMode {
    ...
    public static int armOffset = 95;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(62, 19, Math.toRadians(0));
        ...
        TrajectorySequence pixelRight = drive.trajectorySequenceBuilder(startPose)
                ...
                .strafeLeft(6)
                .lineToLinearHeading(new Pose2d(31, 33, Math.toRadians(-90)), SampleMecanumDrive.getVelocityConstraint(slowerStartingVelocity, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
...
//                .lineToLinearHeading(new Pose2d(-11.5, 32, Math.toRadians(-90)))
                ...
                .lineToLinearHeading(new Pose2d(61.5,60, Math.toRadians(-90))) //park
                .build();
        ...
        TrajectorySequence pixelCenter = drive.trajectorySequenceBuilder(startPose)
                ...
                .waitSeconds(0.25)
                .lineToLinearHeading(new Pose2d(37,35,Math.toRadians(-90))) //spline to backdrop center position
                .waitSeconds(0.4) //inertia
                .addTemporalMarker(() -> {
                    tiltTarget = Arm.tiltStraight + armOffset; //tilt arm to scoring position
                })
        ...
        TrajectorySequence pixelLeft = drive.trajectorySequenceBuilder(startPose)
                ...
                .waitSeconds(0.25)
                .lineToLinearHeading(new Pose2d(31.5,35.5,Math.toRadians(-90))) //spline to backdrop center position
                .waitSeconds(0.4) //inertia
                .addTemporalMarker(() -> {
                    tiltTarget = Arm.tiltStraight + armOffset; //tilt arm to scoring position
                })
