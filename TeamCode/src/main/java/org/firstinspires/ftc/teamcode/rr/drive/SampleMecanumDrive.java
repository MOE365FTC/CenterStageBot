...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(18, 0.5, 2.5); // 23, 9 ,0.5
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(30, 0.2, 0.1); // 16, .1, .1125
